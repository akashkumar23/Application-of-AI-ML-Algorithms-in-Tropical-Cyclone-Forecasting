...
Original file is located at
    https://colab.research.google.com/drive/1SoKBb0zJ876qWWB8G1TnUMoCNF_rz2_9
"""
...
# Import the data.
df = pd.read_csv('/content/drive/MyDrive/sem9/sem9/pacific.csv')
...
for tr, ts in kf.split(x_train):
    ...
    xtr['Latitude'] = pd.to_numeric(xtr['Latitude'], errors='coerce')
    xtr['Longitude'] = pd.to_numeric(xtr['Longitude'], errors='coerce')
    xtr['Latitude_Hemisphere'] = xtr['Latitude_Hemisphere'].astype(int)
    xtr['Longitude_Hemisphere'] = xtr['Longitude_Hemisphere'].astype(int)

    xts['Latitude'] = pd.to_numeric(xts['Latitude'], errors='coerce')
    xts['Longitude'] = pd.to_numeric(xts['Longitude'], errors='coerce')
    xts['Latitude_Hemisphere'] = xts['Latitude_Hemisphere'].astype(int)
    xts['Longitude_Hemisphere'] = xts['Longitude_Hemisphere'].astype(int)
